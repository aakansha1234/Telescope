...
const initialNetwork = NETWORKS.chiado; // <------- select your target frontend network (localhost, goerli, xdai, mainnet)
...
function App(props) {
  ...
  const networkOptions = ["chiado", "scroll", "optimism", "polyzkevm", "taiko"];
  ...
  const purpose = useContractReader(readContracts, "Attestor", "poseidon", [], localProviderPollingTime);
